...
for i in range(1, 16):
    player_sprite = pygame.image.load(f"F:/Nouveau dossier/pYGAME2/Pygame/The Tower Guardian/emmerde/NewPiskel{i}.png")
...
for i in range(1, 11):
    attack_sprite = pygame.image.load(f"F:/Nouveau dossier/pYGAME2/Pygame/The Tower Guardian/Boule de feu/attack_right{i}.png")
