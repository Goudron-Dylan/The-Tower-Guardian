...
blanc = (255, 255, 255)
rouge = (255, 0, 0)
couleur_tour = (0, 0, 255)  # Bleu
couleur_joueur = (0, 255, 0)  # Vert
couleur_monstre = (255, 0, 0)  # Rouge
...
def jeu():
    ...
    while vies_tour > 0 and vies_joueur > 0 and not victoire:  # Ajout de la condition de victoire
        ...
        # Affichage
        fenetre.fill(blanc)
        pygame.draw.rect(fenetre, couleur_tour, (0, hauteur_fenetre // 2, 50, 50))  # Carré bleu pour la tour
        pygame.draw.rect(fenetre, couleur_joueur, (largeur_fenetre // 2, hauteur_fenetre // 2, 50, 50))  # Carré vert pour le joueur
