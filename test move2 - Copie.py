...
# Classe Spawner
class Spawner:
    def __init__(self, x, y, width, height, interval, max_monsters_per_wave):
        self.rect = pygame.Rect(x, y, width, height)
    ...
    def spawn_monster(self):
        ...
        if current_time - self.last_spawn_time > self.interval * 1000:  # Convertir l'intervalle en millisecondes
            if self.monsters_spawned < self.max_monsters_per_wave:
...
spawner1 = Spawner(WINDOW_WIDTH - 100, 890, 50, 50, 2, 15)  # Intervalle en secondes, Limite d'ennemis par vague
spawner2 = Spawner(WINDOW_WIDTH - 100, 590, 50, 50, 2, 15)  # Intervalle en secondes, Limite d'ennemis par vague
spawner3 = Spawner(WINDOW_WIDTH - 100, 290, 50, 50, 2, 15)  # Intervalle en secondes, Limite d'ennemis par vague
