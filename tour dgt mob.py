...
while running:
    ...
    # Dessiner la barre de vie de la tour en utilisant les nouvelles coordonnées
    pygame.draw.rect(window, (0, 255, 0), (tour_health_bar_x, tour_health_bar_y, tour_health_bar_width, tour_health_bar_height))
